...
#chapter-title-page(id: "first", title: "Measurement Methods", authors: [Example Author],
...
// >>> BODY START
== Overview
This chapter cites its own reference @first-shared.
...
#figure(table(columns: (1fr, 3fr), table.header([Quantity], [Description]),
  ...
  caption: [Measurement summary. The complete caption appears in the opening table list.]) <tbl-first>
#figure(image("diagram.svg", width: 80%),
  caption: [Workflow illustration. The blue input connects to the green output.
    This explanation is retained in the opening figure list.]) <fig-first>
// <<< BODY END
#chapter-references("chapters/first.bib", prefix: "first-")
